...
export default function ContactsPage({ user }: ContactsPageProps) {
  ...
  const [callMeStatus, setCallMeStatus] = useState<SubmitStatus>({
    loading: false,
    success: false,
    error: null,
  });

  const handlePhone = async (e: FormEvent<HTMLFormElement>) => {
    e.preventDefault();
