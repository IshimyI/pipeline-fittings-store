...
const CardGrid = ({
  items,
  columns = "md:grid-cols-2 2xl:grid-cols-3 4k:grid-cols-4",
}: CardGridProps) => (
...
const SelectorPage = () => {
  const classificationItems: CardGridItem[] = [
    {
  ...
  const parametersItems: CardGridItem[] = [
    {
  ...
  const applicationsItems: ApplicationItem[] = [
    {
